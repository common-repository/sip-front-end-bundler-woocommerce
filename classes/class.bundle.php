...
class bundle {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( "woo_bundles_cookie-js" );
	...
	public function hidden_inputs() {
		...
		<input type="hidden" name="bundler[min-items]" id="woos-min-items-input" value="1" />
		<input type="hidden" name="bundler[max-items]" id="woos-max-items-input" value="-1" />
	...
	public function submit_html() {
		if( $this->get_field("addcart") == "" ){
			$addcart_message = "Add To Cart";
		}else{
			$addcart_message = $this->get_field("addcart");
		}
		echo '<a href="javascript:void(0);" class="woos-addcart"><span class="fa fa-shopping-cart"></span> ' . $addcart_message . '</a>';
	}
	 ...
	 * @access   public		 
	 */
	public function quantity_input( $total_id = "" ) {
		...
		echo '<input type="number" min="0" id="'.$total_id.'" name="bundler[bundle-quantity]" value="1"' ." readonly" . ' />';
		echo '</div>';
	}
	...
	public function print_estimation() {
		...
		echo '<a href="javascript:void(0);" class="woos-addcart" onclick="javascript:document.getElementById(\'woobundler-form\').submit(); return false;"><span class="fa fa-shopping-cart"></span> ' . $addcart_message . '</a>';
	}
}