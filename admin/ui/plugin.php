<?php 
    ...
    '4' => (object) array(
      ...
      'url'       => SIP_AENWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_FEBWC_VERSION .'&utm_campaign=' .SIP_FEBWC_UTM_CAMPAIGN,
      'title'     => SIP_AENWC_PLUGIN,
      'desc'      => __( 'Powerful email automation.', 'front-end-bundler' ),
    ),
    '5' => (object) array(
